...
public enum BraOfHoldingMaterial implements StringRepresentable, ArmorMaterial {
    BRA_OF_HOLDING("genderless/bra_of_holding", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
    ...
    private BraOfHoldingMaterial(String pName,
