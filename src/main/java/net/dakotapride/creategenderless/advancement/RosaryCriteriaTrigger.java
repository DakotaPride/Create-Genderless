...
public class RosaryCriteriaTrigger extends SimpleCriterionTrigger<RosaryCriteriaTrigger.TriggerInstance> {
    private static final ResourceLocation ID = CreateGenderlessMod.asResource("rosary_count");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(RosaryCriteriaTrigger.ID, player);
        }
