...
public class SaveTheLumarfliesCriteriaTrigger extends SimpleCriterionTrigger<SaveTheLumarfliesCriteriaTrigger.TriggerInstance> {
    private static final ResourceLocation ID = CreateGenderlessMod.asResource("save_the_lumarflies");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(SaveTheLumarfliesCriteriaTrigger.ID, player);
        }
