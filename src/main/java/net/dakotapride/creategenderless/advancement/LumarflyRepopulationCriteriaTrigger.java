...
public class LumarflyRepopulationCriteriaTrigger extends SimpleCriterionTrigger<LumarflyRepopulationCriteriaTrigger.TriggerInstance> {
    private static final ResourceLocation ID = CreateGenderlessMod.asResource("lumarfly_repopulation");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(LumarflyRepopulationCriteriaTrigger.ID, player);
        }
