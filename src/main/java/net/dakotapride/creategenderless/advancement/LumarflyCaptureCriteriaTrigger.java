...
public class LumarflyCaptureCriteriaTrigger extends SimpleCriterionTrigger<LumarflyCaptureCriteriaTrigger.TriggerInstance> {
    private static final ResourceLocation ID = CreateGenderlessMod.asResource("lumarfly_capture");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        public TriggerInstance(ContextAwarePredicate player) {
            super(LumarflyCaptureCriteriaTrigger.ID, player);
        }
