package net.dakotapride.creategenderless.entity.client.leafkin.slabber;// Save this class in your mod and generate all required imports
 ...
 * @author Author
 */
public class LeafkinSlabberAnimations {
	public static final AnimationDefinition LEAFKIN_SLABBER_IDLE = AnimationDefinition.Builder.withLength(3.0F).looping()
	...
	public static final AnimationDefinition LEAFKIN_SLABBER_WALK = AnimationDefinition.Builder.withLength(0.8333F).looping()
		...
		.addAnimation("camo", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.build();

	public static final AnimationDefinition LEAFKIN_SLABBER_SLEEPING = AnimationDefinition.Builder.withLength(4.5F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.25F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
